...
public record FillC2SPacket(BlockBox box, BlockState fill, RegistryKey<Block> replace) implements CustomPayload {
    ...
    public static final MapCodec<FillC2SPacket> CODEC = RecordCodecBuilder.mapCodec(instance -> instance.group(
            ...
            RegistryKey.createCodec(RegistryKeys.BLOCK).optionalFieldOf("replace", null).forGetter(FillC2SPacket::replace)
