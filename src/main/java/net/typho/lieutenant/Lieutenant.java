...
public class Lieutenant implements ModInitializer {
    ...
    public static final ComponentType<BlockBox> BOX_SELECTION_COMPONENT_TYPE = Registry.register(Registries.DATA_COMPONENT_TYPE, Identifier.of(MOD_ID, "box_selection"), ComponentType.<BlockBox>builder().codec(BlockBox.CODEC).packetCodec(PacketCodecs.codec(BlockBox.CODEC)).build());
